...
public class EmsSecurityConfiguration {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
      http.authorizeRequests()
        .requestMatchers("/","/employee/list", "/employee/sort", "/employee/save","/employee/search", "/swagger-ui.html").hasAnyAuthority("USER","ADMIN")
        .requestMatchers("/employee/update","/employee/delete").hasAuthority("ADMIN")
        .requestMatchers("/swagger-ui.html", "/swagger-ui/**", "/v3/api-docs/**", "/swagger-resources/**", "/webjars/**").hasAnyAuthority("USER","ADMIN")
        .requestMatchers("/403").hasAnyAuthority("USER","ADMIN")
